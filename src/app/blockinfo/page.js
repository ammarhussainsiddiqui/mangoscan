        ...
        <div className="card flex flex-col">
          ...
          <div className="grid grid-cols-1 mt-3 gap-x-5 gap-y-2 md:grid-cols-2">
            ...
            <div className="flex flex-col space-y-1 bg-lightground rounded-lg px-3 py-2.5 dark:bg-darkground-3">
              ...
              <div className="flex items-center space-x-2">
                <div className="flex items-baseline font-mono">
                  {/* <span className="text-sm font-semibold text-primary">{block.nonce ? block.nonce.substr(0, 2) : "......"}</span> */}
                  <span className="text-xs text-primary">{block.nonce ? Number(block.nonce) : "......"}</span>
                  <div className="ml-2">
