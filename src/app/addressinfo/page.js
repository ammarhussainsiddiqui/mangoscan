        ...
        {decimals ? (
          ...
          <div className="card flex flex-col">
            ...
            <div className="mt-6 flex flex-col">
              <div className="flex items-center space-x-2">
                <span className="text-base font-medium text-primary break-all">
                ...
                <div className="rounded-lg px-5 py-3 flex flex-wrap w-full bg-lightground justify-between items-center dark:bg-darkground-3">
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <span
                        className="iconify-inline text-primary"
        ...
        <div className="flex flex-col justify-between borderColor pb-3 pt-5 gap-5 lg:flex-row">
          ...
          {decimals ? (
            <div className="flex">
              ...
              >
                 {display === "Transaction" ? (
                  <span className="text-xs text-primary font-medium px-3 py-2 bg-white rounded-lg cursor-default dark:bg-darkground sm:mx-3">
                  ...
                  <span
                    ...
                    className="text-xs text-primary font-medium px-3 py-2 bg-white rounded-lg cursor-default dark:bg-darkground sm:mx-3"
                  >
                    <div
                      style={{ color: "gray" }}
              ...
              <div className="flex flex-col justify-between border-b borderColor pb-3 gap-5 lg:flex-row">
                ...
                <div className="flex flex-col items-end space-y-2">
                  <div className="flex bg-lightground-2 px-1 py-1 rounded-lg items-center dark:bg-darkground-3">
                    ...
                    <a className="py-2 pl-3 pr-2 rounded-lg flex items-center space-x-1 hover:bg-white cursor-pointer text-primary dark:hover:bg-darkground">
                      <span
                        className="iconify-inline"
                        id="copy-undefined"
                    ...
                    <a
                      className="py-2 pl-1 pr-2 rounded-lg flex items-center space-x-1 hover:bg-white cursor-pointer sm:pl-3 text-primary dark:hover:bg-darkground"
