            ...
            <div className="mt-3 flex justify-center relative pb-1">
                <div className="hidden absolute left-0 lg:block">
                    <div className="flex items-center pl-2 space-x-0.5">
                        <div className="flex text-xs space-x-2 bg-primary-1 py-1 px-2 rounded-md dark:bg-darkground-3">
                            <span className="textColor2" style={{ fontSize: 10 }}>
                                ADA
                            </span>
                            <span className="text-primary font-medium">$ 0.29</span>
                        </div>
                        <div className="flex text-xs space-x-2 bg-primary-1 py-1 px-2 rounded-md dark:bg-darkground-3">
                            <span className="textColor2" style={{ fontSize: 10 }}>
                                M Cap
                            </span>
                            <span className="text-primary font-medium">$ 10.21b</span>
                        </div>
                    </div>
                </div>
                <form
                ...
                >
                    ...
                    <button className="px-6 text-white bg-primary hover:bg-primary-70">
