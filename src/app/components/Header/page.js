...
export default function Page() {
  ...
  return (
    <>
      <header>
        <div className="bg-white dark:bg-darkground-1">
            ...
            <div className="hidden lg:block">
              ...
              >
                ...
                {/* <div className="relative" data-dropdown="" data-navigation-group="">
                  ...
                  <div
                    className="origin-top-right absolute left-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-primary-1 px-1 hidden z-50 focus:outline-none dark:bg-darkground-3 dark:ring-darkground-4"
                    role="menu"
                  ...
                  >
                    ...
                    >
                      <a
                        className="pl-3 pr-7 py-2 rounded-md hover:bg-primary-1 dark:hover:bg-darkground-4 hover:text-secondary-1 dark:hover:text-secondaryDark-1"
                        href="/datumInspector"
              ...
              <div className="flex items-center space-x-4">
                <div className="hidden lg:block">
                  <div className="relative" data-dropdown="">
                    <button
                      className="flex items-center rounded-lg pl-3 pr-2 bg-primary-1 hover:bg-primary-2 py-1.5 dark:bg-darkground-4 dark:hover:bg-opacity-80"
                      type="button"
                      aria-expanded="true"
                      aria-haspopup="true"
                      data-dropdown-button=""
                    >
                      ...
                      <span
                        className="ml-2 iconify-inline text-primary"
                        data-icon="mdi:menu-down"
                        data-inline="false"
                        style={{ fontSize: 15 }}
                      />
