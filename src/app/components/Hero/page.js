...
export default function Page() {
  return (
    <>
      <div className="flex flex-col grow appContainer py-10">
        <div className="card flex flex-col space-y-12">
          <Filter />
          <div className="border p-5 rounded-2xl border-primary-1 dark:border-none dark:bg-darkground-3">
            <Records />
          </div>
            ...
            {/* <div style={{ width: 320, height: 110 }}>
              <div className="relative" style={{ width: 320, height: 110 }}>
                ...
                >
                 ...
                 <small
                  className="absolute rounded-md bg-primary-1 text-gray-700"
                  style={{
                    right: 10,
                    top: "-10px",
                    fontSize: 12,
