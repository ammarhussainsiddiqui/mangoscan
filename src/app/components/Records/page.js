        ...
        <>
            <div className="flex flex-col gap-y-4 gap-x-6 md:grid md:grid-cols-2 xl:grid-cols-3">
                <div className="w-full block">
                    ...
                    <div style={{ padding: '25px 10px' }} className="flex gap-x-3 rounded-md items-center bg-lightground-2 pl-3 py-2 gap-y-2 dark:bg-darkground-4 md:flex-col md:items-start lg:py-0 lg:flex-row lg:items-center">
                        <div className="responsiveHide bg-primary-3 w-9 h-9 rounded-md flex items-center justify-center dark:bg-darkground">
                    ...
                    <div style={{ marginTop: '10px' }} className="flex   md:flex-col md:items-start lg:py-0 lg:flex-row lg:items-center">
                        ...
                        <div style={{ padding: '25px 10px', width: '100%', }} className="flex gap-x-3 rounded-md items-center bg-lightground-2 pl-3 py-2 gap-y-2 dark:bg-darkground-4 md:flex-col md:items-start lg:py-0 lg:flex-row lg:items-center">
                            <div className="responsiveHide bg-primary-3 w-9 h-9 rounded-md flex items-center justify-center dark:bg-darkground">
                                <span className="text-2xl font-mediun textColor1">
                                    Ꞗ</span>
                            </div>
                        ...
                        {/* <div style={{ padding: '15px', marginLeft: '5px', marginRight: 'auto', width: '55%', height: '88px', marginBottom: '-8px' }} className="flex gap-x-3 rounded-md items-center bg-lightground-2 pl-3 py-2 gap-y-2 dark:bg-darkground-4 md:flex-col md:items-start lg:py-0 lg:flex-row lg:items-center    ">
                            ...
                            <div className="bg-primary-3 w-9 h-9 rounded-md flex items-center justify-center dark:bg-darkground">
                            <span className="text-2xl font-mediun textColor1">
                            {count > 0 ? count : '🌐'}
                        ...
                        {/* <div className="flex flex-col gap-y-6">
                            <div className="grid grid-cols-1 gap-x-4 gap-y-2 md:grid-cols-2">
                                <div className="flex flex-col px-3 py-2 rounded-md space-y-1 bg-lightground-2 dark:bg-darkground-4">
                                    ...
                                    >
                                        <span
                                            className="text-sm text-primary font-semibold font-mono"
                                            id="current-epoch"
                                        >
                                            0
                                        </span>
                            ...
                            <div className="h-10 rounded-lg flex justify-center items-center relative z-0 bg-primary-1 overflow-hidden dark:bg-darkground-4">
                                <span
                                ...
                                <div
                                    className="absolute z-0 top-0 left-0 bg-primary-70 h-10 rounded-l-lg"
