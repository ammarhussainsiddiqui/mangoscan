          ...
          <div className="card flex flex-col">
            ...
            <div className="flex flex-col justify-between border-b borderColor pb-3 gap-5 lg:flex-row">
              <div className="flex flex-col space-y-2">
                ...
                : 
                <span onClick={() => setDisplay('Transaction')} style={{color:'gold'}} className="cardTitle">Holders Details</span>
                }
            ...
            <div className="grid grid-cols-2 md:grid-cols-2"> 
              <div style={{alignItems:'self-start'}} className="flex flex-col items-end">
                 {display === 'Transaction' ?
                  <span  style={{cursor:'pointer'}} onClick={async () =>{ await getHolders(contractAddress); setDisplay('Transaction') }} className="text-xs text-primary font-medium px-3 py-2 bg-white rounded-lg cursor-default dark:bg-darkground sm:mx-3">
              ...
              <div style={{alignItems:'self-start'}} className="flex flex-col items-end">
                {display === 'Holders' ?
                  <span style={{cursor:'pointer'}} onClick={async () =>{ await getHolders(contractAddress); setDisplay('Holders') }} className="text-xs text-primary font-medium px-3 py-2 bg-white rounded-lg cursor-default dark:bg-darkground sm:mx-3">
                    <div className="text-center flex gap-x-1">
            ...
            <div className="grid grid-cols-1 mt-3 gap-x-5 gap-y-2 md:grid-cols-2"> 
                <div className="flex flex-col space-y-1 bg-lightground rounded-lg px-3 py-2.5 dark:bg-darkground-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {/* <div className="shrink-0">
                      <button
                        className="rounded-full bg-primary-1 flex cursor-pointer dark:bg-darkground h-6 w-6"
                        data-tooltip="Copied"
                        data-tooltip-trigger="click"
                        data-tooltip-timeout={1000}
                      >
                        <span
                          className="m-auto iconify-inline text-primary"
                ...
                <div className="flex flex-col space-y-1 bg-lightground rounded-lg px-3 py-2.5 dark:bg-darkground-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex items-baseline font-mono">
                      <span className="text-sm font-semibold text-primary">{Web3.utils.fromWei(Number(trxdata?.value), "ether")}</span>
                      {/* <span className="text-xs text-primary">914449</span> */}
                      <div className="ml-2">
